(function($) {
    ...
    Pages.prototype.initDropDown = function() {
        ...
        $('.dropdown-default').not(".dropdownIntialized").addClass("dropdownIntialized").each(function() {
    ...
    Pages.prototype.initFormGroupDefault = function() {
        $('.form-group.form-group-default').not(".formGroupDefaultInitialized").addClass("formGroupDefaultInitialized").click(function() {
            $(this).find(':input').focus();
        });
        $('body').not(".formGroupDefaultFocusInitialized").addClass("formGroupDefaultFocusInitialized").on('focus', '.form-group.form-group-default :input', function() {
            $('.form-group.form-group-default').removeClass('focused');
            $(this).parents('.form-group').addClass('focused');
        });

        $('body').not(".formGroupDefaultBlurInitialized").addClass("formGroupDefaultBlurInitialized").on('blur', '.form-group.form-group-default :input', function() {
        ...
        $('.form-group.form-group-default .checkbox, .form-group.form-group-default .radio').not(".formGroupDefaultInitialized").addClass("formGroupDefaultInitialized").hover(function() {
            $(this).parents('.form-group').addClass('focused');
        }, function() {
            $(this).parents('.form-group').removeClass('focused');
        });
    ...
    Pages.prototype.initSlidingTabs = function() {
        ...
        $('a[data-toggle="tab"]').not(".slidingTabInitialized").addClass("slidingTabInitialized").on('show.bs.tab', function(e) {
    ...
    Pages.prototype.initNotificationCenter = function() {
        $('.notification-list .dropdown-menu').not(".notificationInitialized").addClass("notificationInitialized").on('click', function(event) {
            event.stopPropagation();
        });
        $('.toggle-more-details').not(".notificationInitialized").addClass("notificationInitialized").on('click', function(event) {
    ...
    Pages.prototype.initView = function() {
            $('[data-navigate="view"]').not(".viewInitialized").addClass("viewInitialized").on('click', function(e) {
                e.preventDefault();
    ...
    Pages.prototype.initTooltipPlugin = function() {
        $.fn.tooltip && $('[data-toggle="tooltip"]').not(".tooltipInitialized").addClass("tooltipInitialized").tooltip();
    }

    Pages.prototype.initSelect2Plugin = function() {
        $.fn.select2 && $('[data-init-plugin="select2"]').not(".select2Initialized").addClass("select2Initialized").each(function() {
            $(this).select2({
    ...
    Pages.prototype.initScrollBarPlugin = function() {
        $.fn.scrollbar && $('.scrollable').not(".scrollableInitialized").addClass("scrollableInitialized").scrollbar({
            ignoreOverlay: false
        });
    }

    Pages.prototype.initListView = function() {
        $.fn.ioslist && $('[data-init-list-view="ioslist"]').not(".iosListViewInitialized").addClass("iosListViewInitialized").ioslist();
        $.fn.scrollbar && $('.list-view-wrapper').not(".scrollableInitialized").addClass("scrollableInitialized").scrollbar({
            ignoreOverlay: false
        });
    }
    ...
    Pages.prototype.initSwitcheryPlugin = function() {
        ...
        window.Switchery && $('[data-init-plugin="switchery"]').not(".switcheryInitialized").addClass("switcheryInitialized").each(function() {
    ...
    Pages.prototype.initSelectFxPlugin = function() {
        window.SelectFx && $('select[data-init-plugin="cs-select"]').not(".csSelectInitialized").addClass("csSelectInitialized").each(function() {
            var el = $(this).get(0);
    ...
    Pages.prototype.initUnveilPlugin = function() {
        ...
        $.fn.unveil && $("img").not(".unveilInitialized").addClass("unveilInitialized").unveil();
    }
