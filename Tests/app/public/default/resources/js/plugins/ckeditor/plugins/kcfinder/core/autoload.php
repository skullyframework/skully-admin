...
// -- SKULLY ADDITIONAL CHECKING --
// -- CHECK LOGGED IN USER AND FILE PERMISSION --
// === START ===
...
$user = $app->getAdmin();
if(!$user) header('location:'.$app->config('baseUrl').'404.html');
// -- END OF SKULLY ADDITIONAL CHECKING --
