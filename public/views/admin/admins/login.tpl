...
<div class="login-wrapper ">
    ...
    <div class="bg-pic">
        ...
        <img src="{public_url path="images/admin/login.jpg"}" data-src="{public_url path="images/admin/login.jpg"}" data-src-retina="{public_url path="images/admin/login.jpg"}" alt="" class="lazy">
        <!-- END Background Pic-->
    ...
    <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            <div class="p-b-15">
                <img src="{public_url path="images/admin/pages_logo.png"}" alt="logo" data-src="{public_url path="images/admin/pages_logo.png"}" data-src-retina="{public_url path="images/admin/pages_logo_2x.png"}" width="185" height="100">
            </div>
