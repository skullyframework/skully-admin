                                    ...
                                    if (responses.length && responses[0].data) {
                                        ...
                                        if (data.type  == 'uploadOnce') {
                                            if (data.multiple === true){
                                                ...
                                                var url = "{public_url}" + responses[0].path;
                                                var newDetails = "<input type=\"hidden\" name=\"imageUrl\" value=\""+url+"\"><a href=\""+url+"\" class=\"fb\" rel=\"\"><img src=\""+url+"\" class=\"unveilInitialized\"></a>";
                                                $('.image_row-'+data.settingName+' .imageForm .thumbnail').html(newDetails);
                                            }
                                        }
                                    }
                                }
