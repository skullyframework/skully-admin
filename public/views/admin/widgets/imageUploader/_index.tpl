    ...
    <div class="block-fluid image_row-{$imageSettingName}">
        ...
        {if $imageSetting._config.multiple}
            {if $imageSetting.types}
                {include file="admin/widgets/imageUploader/types/_multipleManyTypes.tpl" imageSettingName=$imageSettingName imageSetting=$imageSetting}
            {else}
                {include file="admin/widgets/imageUploader/types/_multipleOneType.tpl" imageSettingName=$imageSettingName imageSetting=$imageSetting}
            {/if}
        {elseif !$imageSetting._config.multiple}
            {if $imageSetting.types}
                {include file="admin/widgets/imageUploader/types/_singleManyTypes.tpl" imageSettingName=$imageSettingName imageSetting=$imageSetting}
            {else}
                {include file="admin/widgets/imageUploader/types/_singleOneType.tpl" imageSettingName=$imageSettingName imageSetting=$imageSetting}
            {/if}
        {/if}
    </div>
{/foreach}
