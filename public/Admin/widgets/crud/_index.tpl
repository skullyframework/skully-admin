...
{*{include file='admin/widgets/_alerts.tpl' }*}
	{*<div class="widget">*}
		{*<div class="head dark">*}
			...
			{*<h2>Stores</h2>*}
			{*<ul class="buttons">*}
				{*<li><a href="{url path='admin/stores/add'}" title="Add Store" data-toggle="dialog"><span class="icos-plus1"></span></a></li>*}
			{*</ul>*}
		{*</div>*}
      ...
      {*{html_table*}
        {*loop=''*}
        {*table_attr='class="'|cat: $sortableTable|cat:' aTable in table-hover" rel="'|cat:{url path='admin/newscategories/index'}|cat:'"style="width: 100%;"'*}
